...
import com.spring.store.config.jwt.JwtAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/authenticate", "/registration", "/activate/*", "/cart/*", "/cart", "/img/**", "/search", "/forgot_password", "/reset_password")
                .permitAll()
